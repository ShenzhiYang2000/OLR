...
p_1_to_0=0.0
p_0_to_1=0.0
params3=(0.1 0.3 0.5 0.7 0.9)


start=4
total_epochs=10
slope_tres=0.05 # 0.025
use_olr=True # False
baseline='none'
train_mode='weak' # 'strong' 
...
for noise_ratio in "${params3[@]}"; do
    ...
    EXP_NAME=DAPO_800_label_flip_${p_1_to_0}_${p_0_to_1}_Qwen3_4B_base_weak_noise_${noise_ratio}_olr_${use_olr}_slope_tres_${slope_tres}_start_${start}_total_epochs_${total_epochs}_${max_response_length}
    ...
    python3 -m verl.trainer.main_olr \
        ...
        trainer.output_log_path=/your_path/log/DAPO_800_label_flip_${p_1_to_0}_${p_0_to_1}_Qwen3_4B_base_weak_noise_${noise_ratio}_olr_${use_olr}_slope_tres_${slope_tres}_start_${start}_total_epochs_${total_epochs}_${max_response_length}.log \
